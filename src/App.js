        ...
        <MainBorder>
          ...
          <BtnBorder>
            <BtnRow>
              ...
              <Button name="9" onClick={onClickNum}>
                9
              </Button>
            ...
            <BtnRow>
              <Button name="4" onClick={onClickNum}>
                4
              </Button>
              <Button name="5" onClick={onClickNum}>
                5
              </Button>
              <Button name="6" onClick={onClickNum}>
                6
              </Button>
              <Button name="-" onClick={calculate}>
                -
            ...
            <BtnRow>
              <Button name="1" onClick={onClickNum}>
                1
              </Button>
              <Button name="2" onClick={onClickNum}>
                2
              </Button>
              <Button name="3" onClick={onClickNum}>
                3
              </Button>
              <Button name="*" onClick={calculate}>
                X
            ...
            <BtnRow>
              <Button name="0" onClick={onClickNum}>
                0
              </Button>
              <Button name="." onClick={onClickNum}>
                .
              </Button>
              <Button name="+" onClick={calculate}>
                +
